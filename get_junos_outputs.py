...
def main():
    ...
    commands = {
        ...
        "route_bgp.l3vpn0": "show route table bgp.l3vpn.0 | display xml | no-more",
        "route_bgp.l3vpn0_extensive": "show route table bgp.l3vpn.0 extensive | display xml | no-more",
